...
let EmojiGateway = EmojiGateway_1 = class EmojiGateway {
    ...
    async create(createEmojiDto, guildOfEmoji) {
        try {
            ...
            this.server.emit(`${guildOfEmoji.guildId}/${emit_1.EmojiSocketEmit.CREATE}`, savedEmoji);
        }
        catch (e) {
            this.logger.error(e);
            return e;
    ...
    async update(updateEmojiDto) {
        try {
            ...
            this.server.emit(`${emit_1.EmojiSocketEmit.UPDATE}/${updateEmojiDto.emojiId}`, updateEmojiDto);
        }
        catch (e) {
            this.logger.error(e);
            return e;
...
], EmojiGateway.prototype, "server", void 0);
__decorate([
    (0, common_1.UseGuards)(jwtWSUser_guard_1.JwtUserWsGuard),
    (0, role_permission_decorator_1.RolePermissions)(['CREATE_EMOJI']),
    ...
    __metadata("design:paramtypes", [createEmoji_dto_1.CreateEmojiDto,
        dtos_1.GuildDto]),
    __metadata("design:returntype", Promise)
], EmojiGateway.prototype, "create", null);
__decorate([
    (0, common_1.UseGuards)(jwtWSUser_guard_1.JwtUserWsGuard),
    (0, role_permission_decorator_1.RolePermissions)(['UPDATE_EMOJI']),
    (0, common_1.UseGuards)(permission_guard_1.GuildPermissionGuard),
    ...
    __metadata("design:returntype", Promise)
], EmojiGateway.prototype, "update", null);
__decorate([
    (0, common_1.UseGuards)(jwtWSUser_guard_1.JwtUserWsGuard),
    (0, role_permission_decorator_1.RolePermissions)(['DELETE_EMOJI']),
    (0, common_1.UseGuards)(permission_guard_1.GuildPermissionGuard),
    (0, websockets_1.SubscribeMessage)(event_1.EmojiSocketEvent.DELETE),
    __param(0, (0, websockets_1.MessageBody)('emojiId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], EmojiGateway.prototype, "delete", null);
EmojiGateway = EmojiGateway_1 = __decorate([
    (0, websockets_1.WebSocketGateway)({ cors: { origin: '*' }, namespace: namespace_1.SocketNamespace.EMOJI }),
