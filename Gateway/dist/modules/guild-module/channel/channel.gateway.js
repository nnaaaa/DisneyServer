...
let ChannelGateway = ChannelGateway_1 = class ChannelGateway {
    ...
    async addMember(memberChannelDto) {
        try {
            ...
            this.server.emit(`${emit_1.ChannelSocketEmit.ADD_MEMBER}/${channel.channelId}`, {
                channel,
                member,
            });
        }
    ...
    async removeMember(memberChannelDto) {
        try {
            ...
            this.server.emit(`${emit_1.ChannelSocketEmit.REMOVE_MEMBER}/${channel.channelId}`, {
                channel,
                member,
            });
        }
...
ChannelGateway = ChannelGateway_1 = __decorate([
    (0, websockets_1.WebSocketGateway)({ cors: { origin: '*' }, namespace: namespace_1.SocketNamespace.CHANNEL }),
