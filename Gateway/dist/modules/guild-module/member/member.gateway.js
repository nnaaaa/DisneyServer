...
let MemberGateway = MemberGateway_1 = class MemberGateway {
    ...
    async botJoinGuild(guildOfMemberDto, botDto) {
        try {
            ...
            this.server.emit(`${guildOfMemberDto.guildId}/${emit_1.MemberSocketEmit.JOIN}`, botMember);
            this.server.emit(`${botDto.botId}/${namespace_1.SocketNamespace.MEMBER}/${emit_1.MemberSocketEmit.JOIN}`, botMember);
            return botMember;
        }
        catch (e) {
            this.logger.error(e);
    ...
    async userJoinGuild(guildOfMemberDto, authUser) {
        try {
            ...
            this.server.emit(`${guildOfMemberDto.guildId}/${emit_1.MemberSocketEmit.JOIN}`, member);
        }
        catch (e) {
            this.logger.error(e);
            return e;
    ...
    async leaveGuild(memberId) {
        try {
            ...
            this.server.emit(`${emit_1.MemberSocketEmit.LEAVE}/${memberId}`, memberLeaveGuild);
            if (memberLeaveGuild.bot) {
                this.server.emit(`${memberLeaveGuild.bot.botId}/${namespace_1.SocketNamespace.MEMBER}/${emit_1.MemberSocketEmit.LEAVE}`, memberLeaveGuild);
            }
        }
        catch (e) {
            this.logger.error(e);
    ...
    async updateMember(updateMemberDto) {
        try {
            ...
            this.server.emit(`${emit_1.MemberSocketEmit.UPDATE}/${member.memberId}`, member);
        }
        catch (e) {
            this.logger.error(e);
        }
...
], MemberGateway.prototype, "server", void 0);
__decorate([
...
], MemberGateway.prototype, "getOfMe", null);
__decorate([
    (0, common_1.UseGuards)(jwtWSUser_guard_1.JwtUserWsGuard),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [guild_dto_1.GuildDto,
        bot_dto_1.BotDto]),
    __metadata("design:returntype", Promise)
], MemberGateway.prototype, "botJoinGuild", null);
__decorate([
    (0, common_1.UseGuards)(jwtWSUser_guard_1.JwtUserWsGuard),
    ...
    __metadata("design:returntype", Promise)
], MemberGateway.prototype, "userJoinGuild", null);
__decorate([
    (0, common_1.UseGuards)(jwtWSUser_guard_1.JwtUserWsGuard),
    ...
    __metadata("design:returntype", Promise)
], MemberGateway.prototype, "leaveGuild", null);
__decorate([
    (0, common_1.UseGuards)(jwtWSUser_guard_1.JwtUserWsGuard),
    ...
    __metadata("design:returntype", Promise)
], MemberGateway.prototype, "updateMember", null);
__decorate([
    (0, common_1.UseGuards)(jwtWSUser_guard_1.JwtUserWsGuard),
...
], MemberGateway.prototype, "memberOnline", null);
MemberGateway = MemberGateway_1 = __decorate([
    (0, websockets_1.WebSocketGateway)({ cors: { origin: '*' }, namespace: namespace_1.SocketNamespace.MEMBER }),
