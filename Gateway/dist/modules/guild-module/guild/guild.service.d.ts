...
export declare class GuildService {
    ...
    constructor(channelCtgService: ChannelCategoryService, roleService: RoleService, memberService: MemberService, emojiService: EmojiService, guildRepository: GuildRepository);
    ...
    findOneWithRelation(findCondition: FindOptionsWhere<GuildEntity>): Promise<GuildEntity>;
    findMany(findCondition: FindOptionsWhere<GuildEntity>): Promise<GuildEntity[]>;
    updateOne(findCondition: FindOptionsWhere<GuildEntity>, updateCondition: QueryDeepPartialEntity<GuildEntity>): Promise<void>;
