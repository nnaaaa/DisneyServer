...
let GuildGateway = GuildGateway_1 = class GuildGateway {
    ...
    async update(updateGuildDto) {
        try {
            await this.guildService.updateOne({ guildId: updateGuildDto.guildId }, updateGuildDto);
            this.server.emit(`${emit_1.GuildSocketEmit.UPDATE}/${updateGuildDto.guildId}`, updateGuildDto);
        }
        catch (e) {
            this.logger.error(e);
            return e;
    ...
    async getOne(guildId, authUser) {
        try {
            ...
            const member = guild.members.find((m) => { var _a; return ((_a = m.user) === null || _a === void 0 ? void 0 : _a.userId) === authUser.userId; });
            return { guild, member };
        }
        catch (e) {
            this.logger.error(e);
...
__decorate([
    (0, common_1.UseGuards)(jwtWSUser_guard_1.JwtUserWsGuard),
    (0, role_permission_decorator_1.RolePermissions)(['UPDATE_GUILD']),
...
__decorate([
    (0, common_1.UseGuards)(jwtWSUser_guard_1.JwtUserWsGuard),
    (0, role_permission_decorator_1.RolePermissions)(['DELETE_GUILD']),
    (0, common_1.UseGuards)(permission_guard_1.GuildPermissionGuard),
    (0, websockets_1.SubscribeMessage)(event_1.GuildSocketEvent.DELETE),
    __param(0, (0, websockets_1.MessageBody)('guildId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], GuildGateway.prototype, "delete", null);
GuildGateway = GuildGateway_1 = __decorate([
    (0, websockets_1.WebSocketGateway)({ cors: { origin: '*' }, namespace: namespace_1.SocketNamespace.GUILD }),
