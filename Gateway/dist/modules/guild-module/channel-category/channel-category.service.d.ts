...
export declare class ChannelCategoryService {
    ...
    create(createChannelCtgDto: CreateChannelCtgDto, guild: GuildDto): Promise<ChannelCategoryEntity>;
    findOneWithRelation(findCondition: FindOptionsWhere<ChannelCategoryEntity>): Promise<ChannelCategoryEntity>;
    findManyWithRelation(findCondition: FindOptionsWhere<ChannelCategoryEntity>): Promise<ChannelCategoryEntity[]>;
    ...
    deleteOne(findCondition: FindOptionsWhere<ChannelCategoryEntity>): Promise<ChannelCategoryEntity>;
    createTemplateCategory(createCategoryDto: CreateChannelCtgDto, guild: GuildEntity, members: MemberEntity[], roles: RoleEntity[]): Promise<ChannelCategoryEntity>;
}
