...
export declare class BotService {
    ...
    constructor(botRepository: BotRepository, authService: AuthService, memberService: MemberService);
    ...
    updateOne(findCondition: FindOptionsWhere<BotEntity>, updateCondition: QueryDeepPartialEntity<BotEntity>): Promise<BotEntity>;
