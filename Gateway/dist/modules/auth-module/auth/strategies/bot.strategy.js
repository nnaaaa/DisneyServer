...
let BotJwtStrategy = class BotJwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'botJwt') {
...
BotJwtStrategy = __decorate([
    ...
    __metadata("design:paramtypes", [config_1.ConfigService, bot_service_1.BotService])
], BotJwtStrategy);
