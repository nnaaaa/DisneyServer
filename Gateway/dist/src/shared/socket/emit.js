...
exports.ReactSocketEmit =
    ...
    exports.ChannelSocketEmit =
    exports.ChannelCtgSocketEmit =
    exports.MemberSocketEmit =
    exports.GuildSocketEmit =
    exports.UserSocketEmit =
        void 0
var UserSocketEmit
...
;(function (ChannelCtgSocketEmit) {
    ...
    (ChannelCtgSocketEmit =
        exports.ChannelCtgSocketEmit || (exports.ChannelCtgSocketEmit = {}))
)
