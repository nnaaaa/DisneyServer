...
__decorate(
    [
        (0, typeorm_1.OneToMany)(
            () => message_entity_1.MesssageEntity,
            (type) => type.channel,
            { cascade: true }
        ),
...
__decorate(
    [
        (0, typeorm_1.ManyToMany)(
            () => guildMember_entity_1.GuildMemberEntity,
            (type) => type.joinedChannels,
            {
                cascade: true,
            }
        ),
...
ChannelEntity = __decorate([(0, typeorm_1.Entity)()], ChannelEntity)
