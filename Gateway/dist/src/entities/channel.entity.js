...
__decorate([
    (0, typeorm_1.OneToMany)(() => message_entity_1.MesssageEntity, (type) => type.channel, { cascade: true }),
    __metadata("design:type", Array)
], ChannelEntity.prototype, "messages", void 0);
__decorate([
    (0, typeorm_1.ManyToMany)(() => guildMember_entity_1.GuildMemberEntity, (type) => type.joinedChannels, {
        cascade: true,
    }),
