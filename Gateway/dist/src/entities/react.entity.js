...
], ReactEntity.prototype, "reactId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => member_entity_1.MemberEntity, (type) => type.sentReacts),
    __metadata("design:type", member_entity_1.MemberEntity)
], ReactEntity.prototype, "author", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => message_entity_1.MessageEntity, (type) => type.reacts),
    __metadata("design:type", message_entity_1.MessageEntity)
], ReactEntity.prototype, "message", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => emoji_entity_1.EmojiEntity, (type) => type.reacts),
    __metadata("design:type", emoji_entity_1.EmojiEntity)
], ReactEntity.prototype, "emoji", void 0);
