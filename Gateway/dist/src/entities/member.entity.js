...
], MemberEntity.prototype, "memberId", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)(),
    __metadata("design:type", Date)
], MemberEntity.prototype, "joinAt", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
...
__decorate([
    ...
    __metadata("design:type", String)
], MemberEntity.prototype, "avatarUrl", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.UserEntity, (type) => type.joinedGuilds, {
        onDelete: 'CASCADE',
        nullable: true,
    }),
...
], MemberEntity.prototype, "guild", void 0);
__decorate([
    (0, typeorm_1.ManyToMany)(() => role_entity_1.RoleEntity, (type) => type.members, {
        cascade: true,
    }),
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => channel_entity_1.ChannelEntity, (type) => type.members),
    __metadata("design:type", Array)
], MemberEntity.prototype, "joinedChannels", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => message_entity_1.MessageEntity, (type) => type.author, { cascade: true }),
    __metadata("design:type", Array)
], MemberEntity.prototype, "sentMessages", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => react_entity_1.ReactEntity, (type) => type.author, { cascade: true }),
    __metadata("design:type", Array)
], MemberEntity.prototype, "sentReacts", void 0);
