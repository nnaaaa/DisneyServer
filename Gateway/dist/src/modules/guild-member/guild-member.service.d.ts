...
export declare class GuildMemberService {
    ...
    findOneWithRelation(findCondition: FindOptionsWhere<GuildMemberEntity>): Promise<GuildMemberEntity>;
    findManyWithRelation(findCondition: FindOptionsWhere<GuildMemberEntity>): Promise<GuildMemberEntity[]>;
    updateOne(findCondition: FindOptionsWhere<GuildMemberEntity>, updateCondition: QueryDeepPartialEntity<GuildMemberEntity>): Promise<GuildMemberEntity>;
