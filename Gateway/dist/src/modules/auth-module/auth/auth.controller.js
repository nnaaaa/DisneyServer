...
let AuthController = class AuthController {
    ...
    async googleAuthRedirect(req, res) {
        try {
            ...
            const refreshToken = await this.authService.getUserRefreshToken(req.user.userId);
            return res.redirect(`http://localhost:3000?accessToken=${accessToken}&refreshToken=${refreshToken}`);
        }
    }
};
__decorate([
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [forgetPassword_dto_1.NewPasswordWithComparationDto]),
    __metadata("design:returntype", Promise)
