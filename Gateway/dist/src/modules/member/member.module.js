...
MemberModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        providers: [message_service_1.MessageService, react_service_1.ReactService, member_service_1.MemberService, member_gateway_1.MemberGateway],
        exports: [typeorm_1.TypeOrmModule, member_service_1.MemberService, member_gateway_1.MemberGateway, message_module_1.MessageModule, react_module_1.ReactModule],
    })
], MemberModule);
