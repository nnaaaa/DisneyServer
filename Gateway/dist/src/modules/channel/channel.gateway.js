...
let ChannelGateway = (ChannelGateway_1 = class ChannelGateway {
    ...
    async create(createChannelDto, categoryDto, firstMemberDto) {
        try {
            ...
            this.server.emit(
                `${categoryDto.categoryId}/${emit_1.ChannelSocketEmit.CREATE}`,
                savedChannel
            )
        } catch (e) {
            this.logger.error(e)
    ...
    async update(updateChannelDto) {
        try {
            ...
            this.server.emit(
                `${emit_1.ChannelSocketEmit.UPDATE}/${updateChannelDto.channelId}`,
                channel
            )
        } catch (e) {
            this.logger.error(e)
...
__decorate(
    [
        ...
        __metadata('design:paramtypes', [
            createChannel_dto_1.CreateChannelDto,
