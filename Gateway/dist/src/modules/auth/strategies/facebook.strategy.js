...
let FacebookStrategy = class FacebookStrategy extends (0, passport_1.PassportStrategy)(passport_facebook_1.Strategy) {
    constructor(configService) {
        super({
            clientID: configService.get('FACEBOOK_ID'),
            clientSecret: configService.get('FACEBOOK_SECRET'),
            callbackURL: `http://${configService.get('SERVER_HOST')}:${configService.get('SERVER_PORT')}/auth/facebook/redirect`,
