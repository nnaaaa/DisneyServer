...
EmojiModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([emoji_entity_1.EmojiEntity]), auth_module_1.AuthModule, react_module_1.ReactModule],
        providers: [emoji_service_1.EmojiService, emoji_gateway_1.EmojiGateway, react_service_1.ReactService],
        exports: [typeorm_1.TypeOrmModule, emoji_service_1.EmojiService, react_module_1.ReactModule],
    })
], EmojiModule);
