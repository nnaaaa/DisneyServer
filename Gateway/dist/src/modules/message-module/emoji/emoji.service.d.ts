...
export declare class EmojiService {
    ...
    findOneWithRelation(findCondition: FindOptionsWhere<EmojiEntity>): Promise<EmojiEntity>;
    findManyWithRelation(findCondition: FindOptionsWhere<EmojiEntity>): Promise<EmojiEntity[]>;
