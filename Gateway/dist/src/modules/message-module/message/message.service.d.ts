...
export declare class MessageService {
    ...
    constructor(messageRepository: MessageRepository, actionService: ActionService, buttonService: ButtonService, reactService: ReactService, selectService: SelectService);
