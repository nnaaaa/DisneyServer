...
let MessageGateway = MessageGateway_1 = class MessageGateway {
    ...
    async create(createMessageDto, destinationDto, authorDto, replyTo, userOrBot) {
        try {
            ...
            this.server.emit(`botManager/${userOrBot === null || userOrBot === void 0 ? void 0 : userOrBot.botId}/${namespace_1.SocketNamespace.MESSAGE}/${emit_1.MessageSocketEmit.CREATE}`, message);
            return message;
        }
        catch (e) {
            this.logger.error(e);
    ...
    async update(updateMessageDto, userOrBot) {
        try {
            ...
            this.server.emit(`botManager/${userOrBot === null || userOrBot === void 0 ? void 0 : userOrBot.botId}/${namespace_1.SocketNamespace.MESSAGE}/${emit_1.MessageSocketEmit.UPDATE}`, updatedMessage);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [updateMessage_dto_1.UpdateMessageDto, Object]),
    __metadata("design:returntype", Promise)
