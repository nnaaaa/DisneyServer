...
let ChannelCategoryGateway = (ChannelCategoryGateway_1 = class ChannelCategoryGateway {
    ...
    async create(createChannelCtgDto, guild) {
        try {
            ...
            this.server.emit(
                `${guild.guildId}/${emit_1.ChannelCtgSocketEmit.CREATE}`,
    ...
    async update(updateChannelCtgDto) {
        try {
            ...
            this.server.emit(
                `${emit_1.ChannelCtgSocketEmit.UPDATE}/${updateChannelCtgDto.categoryId}`,
                updateChannelCtgDto
            )
        } catch (e) {
            this.logger.error(e)
...
__decorate(
    ...
    ChannelCategoryGateway.prototype,
    'server',
    void 0
)
__decorate(
    [
        ...
        __metadata('design:paramtypes', [
            createChannelCtg_dto_1.CreateChannelCtgDto,
            dtos_1.GuildDto,
        ]),
...
__decorate(
    [
        ...
        (0, common_1.UseGuards)(permission_guard_1.GuildPermissionGuard),
        (0, common_1.UsePipes)(new common_1.ValidationPipe()),
        __param(0, (0, websockets_1.MessageBody)('categoryId')),
        __metadata('design:type', Function),
