...
export declare class MemberService {
    ...
    constructor(memberRepository: MemberRepository, messageService: MessageService, reactService: ReactService);
    ...
    findOneWithRelation(findCondition: FindOptionsWhere<MemberEntity>): Promise<MemberEntity>;
    findManyWithRelation(findCondition: FindOptionsWhere<MemberEntity>): Promise<MemberEntity[]>;
    updateOne(findCondition: FindOptionsWhere<MemberEntity>, updateCondition: QueryDeepPartialEntity<MemberEntity>): Promise<MemberEntity>;
