...
let MemberService = class MemberService {
    ...
    async botJoin(guildOfMemberDto, botDto) {
        ...
        if (isJoined)
            throw new common_1.ConflictException('Bot is already joined');
    ...
    async userJoin(guildOfMemberDto, userDto) {
        ...
        if (isJoined)
            throw new common_1.ConflictException('User is already joined');
...
MemberService = __decorate([
    ...
    __metadata("design:paramtypes", [userJoinGuild_repository_1.MemberRepository,
