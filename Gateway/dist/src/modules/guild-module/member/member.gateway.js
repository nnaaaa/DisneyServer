...
let MemberGateway = MemberGateway_1 = class MemberGateway {
    ...
    async joinGuild(guildOfMemberDto, authUser) {
        try {
            ...
            this.server.emit(`${guildOfMemberDto.guildId}/${emit_1.MemberSocketEmit.JOIN}`, savedMember);
        }
        catch (e) {
            this.logger.error(e);
...
], MemberGateway.prototype, "joinGuild", null);
__decorate([
    (0, common_1.UseGuards)(jwtWS_guard_1.JwtWsGuard),
...
MemberGateway = MemberGateway_1 = __decorate([
    (0, websockets_1.WebSocketGateway)({ cors: { origin: '*' }, namespace: 'member' }),
