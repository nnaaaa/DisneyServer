...
let RoleGateway = RoleGateway_1 = class RoleGateway {
    ...
    async addToMember(memberRoleDto) {
        try {
            ...
            this.server.emit(`${emit_1.RoleSocketEmit.ADD_TO_MEMBER}/${role.roleId}`, {
                member,
                role,
            });
            return { member, role };
    ...
    async removeFromMember(memberRoleDto) {
        try {
            ...
            this.server.emit(`${emit_1.RoleSocketEmit.REMOVE_FROM_MEMBER}/${role.roleId}`, {
                member,
                role,
            });
        }
    ...
    async addToChannel(channelRoleDto) {
        try {
            ...
            this.server.emit(`${emit_1.RoleSocketEmit.ADD_TO_CHANNEL}/${role.roleId}`, {
                channel,
                role,
            });
        }
    ...
    async removeFromChannel(channelRoleDto) {
        try {
            ...
            this.server.emit(`${emit_1.RoleSocketEmit.REMOVE_FROM_CHANNEL}/${role.roleId}`, {
                channel,
                role,
            });
        }
...
__decorate([
    ...
    __param(0, (0, websockets_1.MessageBody)('roleId')),
    __metadata("design:type", Function),
...
RoleGateway = RoleGateway_1 = __decorate([
    (0, websockets_1.WebSocketGateway)({ cors: { origin: '*' }, namespace: namespace_1.SocketNamespace.ROLE }),
