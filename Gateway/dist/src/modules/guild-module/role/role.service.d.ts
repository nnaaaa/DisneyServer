...
export declare class RoleService {
    ...
    constructor(roleRepository: RoleRepository, channelService: ChannelService, memberService: MemberService);
    ...
    findManyWithReletion(findCondition: FindOptionsWhere<RoleEntity>): Promise<RoleEntity[]>;
